...
class NotificationsController extends Controller
{
    ...
    public function index()
    {
        ...
        $module_title = __('notification.title');
        ...
        return view(
            ...
            compact('module_title', 'module_name', "$module_name", 'module_path', 'module_icon', 'module_action', 'module_name_singular', 'unread_notifications_count', 'notifications_count','module_title')
        );
    }
    ...
    public function deleteAll()
    {
        ...
        $module_action = __('messages.delete_all');

        $user = auth()->user();

        $user->notifications()->delete();

        Flash::success("<i class='fas fa-check'></i>" . __('messages.all_notifications_deleted'))->important();
    ...
    public function markAllAsRead()
    {
        ...
        $module_action = __('messages.make_all_as_read');

        $user = auth()->user();

        $user->unreadNotifications()->update(['read_at' => now()]);

        Flash::success("<i class='fas fa-check'></i> ".__('messages.all_notifications_marked_as_read'))->important();
