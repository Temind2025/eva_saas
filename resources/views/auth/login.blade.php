        ...
        <form method="POST" action="{{ $url ?? route('login') }}">
            ...
            <div>
                ...
                <x-input id="email"
                         ...
                         title="{{ __('messages.invalid_email_format') }}" />

                <!-- Custom error message for invalid email format -->
                <span id="emailError" class="text-danger" style="display: none;">{{ __('messages.invalid_email_format') }}</span>
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="password"
                         ...
                         title="{{ __('messages.password_must_be_between_8_and_12_characters') }}" />

                <!-- Custom error message for invalid password length -->
                <span id="passwordError" class="text-danger" style="display: none;">{{ __('messages.password_must_be_between_8_and_12_characters') }}</span>
            </div>
        ...
        <x-slot name="extra">
            @if (Route::has('register'))
                <p class="text-center text-gray-600 mt-4">
                    {{ __('messages.do_not_have_an_account') }} <a href="{{ route('register') }}"
                        class="underline hover:text-gray-900">{{ __('messages.register') }}</a>.
                </p>
            @endif
        </x-slot>
    </x-auth-card>
