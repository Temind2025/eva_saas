              ...
              <div>
                ...
                <x-slot name="toolbar">
                    <div class="input-group gap-2">
                        <input type="text" name="booking_date" id="booking_date" placeholder="{{ __('messages.select_date_range') }}" class="booking-date-range form-control flex-grow-1 px-3 birder rounded" readonly />
