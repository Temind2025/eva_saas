...
const validationSchema = yup.object({
  razorpay_secretkey: yup.string().test('razorpay_secretkey', t('messages.razorpay_secretkey'), function (value) {
    if (this.parent.razor_payment_method == 1 && !value) {
      return false;
    }
    return true
  }),
  razorpay_publickey: yup.string().test('razorpay_publickey', t('messages.razorpay_publickey'), function (value) {
    if (this.parent.razor_payment_method == 1 && !value) {
  ...
  stripe_secretkey: yup.string().test('stripe_secretkey', t('messages.stripe_secretkey'), function (value) {
    if (this.parent.str_payment_method == 1 && !value) {
      return false;
    }
    return true
  }),
  stripe_publickey: yup.string().test('stripe_publickey', t('messages.stripe_publickey'), function (value) {
    if (this.parent.str_payment_method == 1 && !value) {
      return false;
    }
    return true
  ...
  paystack_secretkey: yup.string().test('paystack_secretkey', t('messages.paystack_secretkey'), function (value) {
    if (this.parent.paystack_payment_method == 1 && !value) {
      return false;
    }
    return true
  }),
  paystack_publickey: yup.string().test('paystack_publickey', t('messages.paystack_publickey'), function (value) {
    if (this.parent.paystack_payment_method == 1 && !value) {
      return false;
    }
    return true
  ...
  paypal_secretkey: yup.string().test('paypal_secretkey', t('messages.paypal_secretkey'), function (value) {
    if (this.parent.paypal_payment_method == 1 && !value) {
      return false;
    }
    return true
  }),
  paypal_clientid: yup.string().test('paypal_clientid', t('messages.paypal_clientid'), function (value) {
    if (this.parent.paypal_payment_method == 1 && !value) {
      return false;
    }
    return true
  ...
  flutterwave_secretkey: yup.string().test('flutterwave_secretkey', t('messages.flutterwave_secretkey'), function (value) {
    if (this.parent.flutterwave_payment_method == 1 && !value) {
      return false;
    }
    return true
  }),
  flutterwave_publickey: yup.string().test('flutterwave_publickey', t('messages.flutterwave_publickey'), function (value) {
    if (this.parent.flutterwave_payment_method == 1 && !value) {
      return false;
    }
    return true
  ...
  cinet_clientid: yup.string().test('cinet_clientid', t('messages.cinet_clientid'), function (value) {
  ...
  cinet_apikey: yup.string().test('cinet_apikey', t('messages.cinet_apikey'), function (value) {
    if (this.parent.cinet_payment_method == 1 && !value) {
      return false;
    }
    return true
  }),
  cinet_secretkey: yup.string().test('cinet_secretkey', t('messages.cinet_secretkey'), function (value) {
    if (this.parent.cinet_payment_method == 1 && !value) {
      return false;
    }
    return true
  ...
  sadad_clientid: yup.string().test('sadad_clientid', t('messages.sadad_clientid'), function (value) {
  ...
  sadad_secretkey: yup.string().test('sadad_secretkey', t('messages.sadad_secretkey'), function (value) {
    if (this.parent.sadad_payment_method == 1 && !value) {
      return false;
    }
    return true
  ...
  sadad_domain: yup.string().test('sadad_domain', t('messages.sadad_domain'), function (value) {
    if (this.parent.sadad_payment_method == 1 && !value) {
      return false;
    }
    return true
  ...
  airtelmoney_clientid: yup.string().test('airtelmoney_clientid', t('messages.airtelmoney_clientid'), function (value) {
  ...
  airtelmoney_secretkey: yup.string().test('airtelmoney_secretkey', t('messages.airtelmoney_secretkey'), function (value) {
    if (this.parent.airtelmoney_payment_method == 1 && !value) {
      return false;
    }
    return true
  ...
  phonepay_appid: yup.string().test('phonepay_appid', t('messages.phonepay_appid'), function (value) {
  ...
  phonepay_merchentid: yup.string().test('phonepay_merchentid', t('messages.phonepay_merchentid'), function (value) {
    if (this.parent.phonepay_payment_method == 1 && !value) {
      return false;
    }
    return true
  ...
  phonepay_saltid: yup.string().test('phonepay_saltid', t('messages.phonepay_saltid'), function (value) {
    if (this.parent.phonepay_payment_method == 1 && !value) {
      return false;
    }
    return true
  ...
  phonepay_saltkey: yup.string().test('phonepay_saltkey', t('messages.phonepay_saltkey'), function (value) {
    if (this.parent.phonepay_payment_method == 1 && !value) {
      return false;
    }
    return true
  ...
  midtrans_clientid: yup.string().test('midtrans_clientid', t('messages.midtrans_clientid'), function (value) {
