    ...
    public function run()
    {
        ...
        $subscriptions = [
            ...
            [
                ...
                'total_amount' => 120,
                'currency' => 'USD',
                'start_date' => Carbon::parse('2025-01-13'),
                'end_date' => Carbon::parse('2025-03-13'),
                'status' => 'active' ,
                'payment_method' => 2, // Online
                'gateway_type' => 'stripe',
                'gateway_response' => json_encode(['status' => 'success']),
            ...
            [
                ...
                'total_amount' => 120,
                'currency' => 'USD',
                'start_date' => Carbon::parse('2025-01-04'),
            ...
            [
                ...
                'total_amount' => 52.5,
                'currency' => 'USD',
                'start_date' => Carbon::parse('2024-12-07'),
                'end_date' => Carbon::parse('2025-01-07'),
                'status' => 'Inactive',
                'payment_method' => 1, // Offline
                'gateway_type' => 'manual',
                'gateway_response' => json_encode(['status' => 'success']),
