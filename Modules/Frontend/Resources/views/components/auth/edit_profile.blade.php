                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 mt-md-0 mt-4 ps-md-0 ps-3">
                                            <form id="editProfileDetail">
                                                ...
                                                <div class="form-group mb-3">
                                                    <div class="input-group custom-input-group">
                                                        <input type="tel" class="form-control" value="{{ $user->mobile }}" id="mobileInput"  required>
                                                ...
                                                <div class="form-group mb-3">
                                                    <label class="form-label mb-3">{{('messages.gender')}}<span class="text-danger">*</span></label>
...
// Trigger the file input when clicking the pencil icon
        ...
        // Validate gender selection in real-time
