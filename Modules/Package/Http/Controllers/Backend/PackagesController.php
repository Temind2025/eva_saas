...
class PackagesController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = __('package.title');
        // module name
    ...
    public function index(Request $request)
    {
        ...
        $export_columns = [
            ...
            [
                'value' => 'end_date',
                'text' => __('messages.expiry_date'),
            ],
        ];
        $export_url = route('backend.package.export');

        return view('package::backend.packages.index_datatable', compact('module_action', 'filter', 'columns', 'customefield', 'export_import', 'export_columns', 'export_url','module_title'));
    }
    ...
    public function index_list(Request $request)
    {
        ...
        if($branchId){
            $query_data = $query_data->where('branch_id', $branchId);
        }
    ...
    public function userPackageList(Request $request, $user_id)
    {
        ...
        foreach ($query_data as $row) {
            ...
            if($row->bookingTransaction && $row->bookingTransaction->payment_status==1){
            $services = [];
    ...
    public function index_data(Request $request)
    {
        ...
        return Datatables::of($query)
            ...
            ->rawColumns(['action', 'status', 'package_price', 'check', 'qty'])
    ...
    public function store(Request $request)
    {
        ...
        $message = __('messages.new_package_added');
    ...
    public function update(Request $request, $id)
    {
        ...
        $message = __('messages.package_update');
    ...
    public function destroy($id)
    {
        ...
        $message = __('messages.package_delete');
    ...
    public function clientView(Request $request)
    {
        ...
        // Page Title
        $this->module_title = __('sidebar.customer_packages');
        // module name
        $this->module_name = 'package';
