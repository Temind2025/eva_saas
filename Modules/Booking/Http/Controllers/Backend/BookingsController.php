...
class BookingsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $booking = Booking::with(['services', 'user', 'products', 'userCouponRedeem'])
    ...
    public function viewInvoice(Request $request)
    {
        ...
        $booking = Booking::with(['services', 'user', 'products', 'userCouponRedeem', 'packages','branch'])->where('status', 'completed')->where('created_by', auth()->id())->find($request->id);
